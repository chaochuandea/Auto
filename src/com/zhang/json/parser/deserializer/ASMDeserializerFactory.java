...
import static com.zhang.json.util.ASMUtils.getDesc;
import static com.zhang.json.util.ASMUtils.getType;
...
import com.zhang.json.asm.ClassWriter;
import com.zhang.json.asm.FieldVisitor;
import com.zhang.json.asm.Label;
import com.zhang.json.asm.MethodVisitor;
import com.zhang.json.asm.Opcodes;
import com.zhang.json.parser.DefaultJSONParser;
import com.zhang.json.parser.Feature;
import com.zhang.json.parser.JSONLexer;
import com.zhang.json.parser.JSONLexerBase;
import com.zhang.json.parser.JSONToken;
import com.zhang.json.parser.ParseContext;
import com.zhang.json.parser.ParserConfig;
import com.zhang.json.parser.SymbolTable;
import com.zhang.json.parser.DefaultJSONParser.ResolveTask;
import com.zhang.json.parser.deserializer.ASMJavaBeanDeserializer.InnerJavaBeanDeserializer;
import com.zhang.json.util.ASMClassLoader;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.zhang.json.asm.Type.getType(getDesc(fieldClass)));
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(com.zhang.json.asm.Type.getType(getDesc(itemClass)));
    ...
    void _deserialze(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(com.zhang.json.asm.Type.getType(getDesc(fieldClass))); // cast
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_list_item_deser__",
                          getDesc(ObjectDeserializer.class));
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.zhang.json.asm.Type.getType(getDesc(itemType)));
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass) {
        ...
        if (fieldInfo.getFieldType() instanceof Class) {
            mw.visitLdcInsn(com.zhang.json.asm.Type.getType(getDesc(fieldInfo.getFieldClass())));
        } else {
            mw.visitVarInsn(ALOAD, 0);
            mw.visitLdcInsn(fieldInfo.getName());
