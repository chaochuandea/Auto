...
import com.zhang.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.canonicalName
     */
    private static ConcurrentHashMap<String, com.zhang.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.zhang.db.table.Id>();

    public static synchronized com.zhang.db.table.Id getId(Class<?> entityType) {
        ...
        com.zhang.db.table.Id id = new com.zhang.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getCanonicalName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.zhang.db.table.Id id = getId(entityType);
